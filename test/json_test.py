...
class MotionINI:
    ...
    def write(self):
        ...
        self.config.set('OUTPUT', '; csv_frames_per_second', 'on')
...
print(type(camera_controls))
if camera_controls:
    camera_controls_json = json.loads(camera_controls)
    print(type(camera_controls_json))
